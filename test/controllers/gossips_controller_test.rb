...
class GossipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gossip" do
    assert_difference('Gossip.count') do
      post gossips_url, params: { gossip: { content_gossip: @gossip.content_gossip, title: @gossip.title, user_id: @gossip.user_id } }
    end
  ...
  test "should update gossip" do
    patch gossip_url(@gossip), params: { gossip: { content_gossip: @gossip.content_gossip, title: @gossip.title, user_id: @gossip.user_id } }
